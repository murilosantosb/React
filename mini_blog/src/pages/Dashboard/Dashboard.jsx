...
const Dashboard = () => {
  ...
  const uid = user.uid
  const {deleteDocument: deletedDocument} = useDeleteDocument("posts")
          ...
          <div className={styles.post_header}>
            ...
            {posts && posts.map((post) => (<div key={post.id} className={styles.post_row}>
              ...
              <div>
                ...
                <button onClick={() => deletedDocument(post.id)} className='btn btn-outline btn-danger'>Excluir</button>
              </div>
